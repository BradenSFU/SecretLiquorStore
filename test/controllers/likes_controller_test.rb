...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post likes_url, params: { like: { drink_id: @like.drink_id, islike: @like.islike, user_id: @like.user_id } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { drink_id: @like.drink_id, islike: @like.islike, user_id: @like.user_id } }
