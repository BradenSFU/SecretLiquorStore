...
class DrinksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create drink" do
    assert_difference('Drink.count') do
      post drinks_url, params: { drink: { Dname: @drink.Dname, drink_id: @drink.drink_id, user_id: @drink.user_id } }
    end
  ...
  test "should update drink" do
    patch drink_url(@drink), params: { drink: { Dname: @drink.Dname, drink_id: @drink.drink_id, user_id: @drink.user_id } }
